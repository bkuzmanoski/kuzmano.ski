...
import { DETENT_PIXELS, IDLE_DURATION_MS } from "#/lib/audio/scroll";
...
// Safari animates the scroll that reveals a focused element, so it arrives as a
// run of scroll events after the focus rather than as one jump before it.
